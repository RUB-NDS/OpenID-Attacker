...
/**
 * Processor which hold the business logic for OpenId requests.
 */
public class CustomOpenIdProcessor extends AbstractBean {
    ...
    public CustomOpenIdProcessor(IdpType idpType) {
