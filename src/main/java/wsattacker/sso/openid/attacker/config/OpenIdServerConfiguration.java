...
public final class OpenIdServerConfiguration extends AbstractBean implements Serializable {
	...
	public static final String PROP_SERVERLISTENHOST = "serverListenHost";
	...
	private String serverListenHost = "0.0.0.0";
	...
	/**
	 * Get the value of serverListenHost
	 *
	 * @return the value of serverListenHost
	 */
	...
	/**
	 * Set the value of serverListenHost
	 *
	 * @param serverListenHost new value of serverListenHost
	 */
	public void setServerListenHost(String serverListenHost) {
		String oldServerListenHost = this.serverListenHost;
		this.serverListenHost = serverListenHost;
		firePropertyChange(PROP_SERVERLISTENHOST, oldServerListenHost, serverListenHost);
	}
